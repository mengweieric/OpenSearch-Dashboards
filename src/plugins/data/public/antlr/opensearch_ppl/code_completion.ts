...
const q2 =
  "source=opensearch_dashboards_sample_data_logs | where `timestamp` > DATE_SUB(NOW(), INTERVAL 1 DAY) | where machine.os='osx' or  machine.os='ios' |  stats avg(machine.ram) by span(timestamp,1d)";
